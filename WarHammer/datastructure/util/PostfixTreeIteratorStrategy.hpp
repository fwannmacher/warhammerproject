 ...
 *
 * PostfixTreeIteratorStrategy.hpp
 *
...
#ifndef __WarHammer_datastructure_util_POSTFIXTREEITERATORSTRATEGY_HPP__
#define __WarHammer_datastructure_util_POSTFIXTREEITERATORSTRATEGY_HPP__
...
namespace WarHammer
{
	namespace datastructure
	{
		namespace util
		{
			...
			/**
			 * @class WarHammer::datastructure::util::PostfixTreeIteratorStrategy
			 *
			 * @brief An implementation of WarHammer::datastructure::util::IIteratorStrategy based on Post-fix Tree walk.
			 *
			 * This class implements the algorithm of Post-fix Tree walk to the WarHammer::datastructure::Iterator.
			 *
			 ...
			 *
			 * @see WarHammer::datastructure::util::PrefixTreeIteratorStrategy
			...
			class PostfixTreeIteratorStrategy: public IIteratorStrategy<TreeNodeSubclass, Content>
			{
			public:
				PostfixTreeIteratorStrategy(void);
				virtual ~PostfixTreeIteratorStrategy(void);
				/**
				 * @brief Verifies if the iterator can move to the next node.
				 *
				 * Verifies if the iterator can move to the next node based on the Tree Post-fix walk context.
				 *
				 ...
				 *
				 * Verifies if the iterator can move to the previous node based on the Tree Post-fix walk context.
				 *
				 ...
				 *
				 * Searches the next node for the iteration based on the Tree Post-fix walk context.
				 *
				 ...
				 *
				 * Searches the previous node for the iteration based on the Tree Post-fix walk context.
				 *
				 ...
				 *
				 * Searches the first node for the iteration walking through the root of the tree based on the Tree Post-fix walk context.
				 *
				 ...
				 *
				 * Searches the last node for the iteration walking through the root of the tree based on the Tree Post-fix walk context.
				 *
				 * @param root The root node of the tree.
				 *
...
#include "PostfixTreeIteratorStrategy.tpp"
