 ...
 *
 * ExpressionInterpreterStringParser.hpp
 *
...
#ifndef __WarHammer_util_EXPRESSIONINTERPRETERSTRINGPARSER_HPP__
#define __WarHammer_util_EXPRESSIONINTERPRETERSTRINGPARSER_HPP__
...
namespace WarHammer
{
	namespace util
	{
		...
		template<typename ExpressionResult>
		class ExpressionInterpreterStringParser: public IExpressionInterpreterComponent<ExpressionResult>
		{
		private:
			WarHammer::util::String _expression;
			ExpressionResult _expressionResult;
		public:
			ExpressionInterpreterStringParser(WarHammer::util::String expression);
			virtual ~ExpressionInterpreterStringParser(void);
...
#include "ExpressionInterpreterStringParser.tpp"
