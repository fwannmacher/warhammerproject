...
#ifndef __WarHammer_binding_java_METHOD_HPP__
#define __WarHammer_binding_java_METHOD_HPP__
...
namespace WarHammer
{
	namespace binding
	{
		namespace java
		{
			...
			protected:
				Method(jmethodID identification, JNIEnv* JNIEnvironment, unsigned int returnTypeCode, WarHammer::util::String JNIEnvironmentReturnType);
			public:
				virtual ~Method(void);
				virtual Return call(jobject JNIEnvironmentObject, MethodParameterList methodParameterList) = 0;
